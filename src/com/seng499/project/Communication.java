...
public class Communication extends Activity {
	...
	// Key names received from the CommunicationService Handler
	...
	// The Handler that gets information back from the CommunicationService
